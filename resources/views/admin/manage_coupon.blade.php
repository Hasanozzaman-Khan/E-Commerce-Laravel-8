                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="type" class="form-control" name="type" aria-required="true" aria-invalid="false" required>
                                        @if($type=="Value")
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="is_one_time" class="form-control" name="is_one_time" aria-required="true" aria-invalid="false" required>
                                        @if($is_one_time=="1")
