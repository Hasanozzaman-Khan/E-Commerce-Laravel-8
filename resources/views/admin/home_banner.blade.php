...
@section('container')
  ...
  <h3>HomeBanner</h3>
  <a class="my-3" href="{{url('admin/home_banner/manage_home_banner')}}">
            ...
            <table class="table table-borderless table-data3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($list->image != '')
                                <img width="50px" src="{{asset('storage/media/banner/'.$list->image)}}" alt="image">
                            @endif
                        </td>
                        <td>{{$list->btn_text}}</td>
                        <td>
